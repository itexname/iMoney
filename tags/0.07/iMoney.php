...
Version: 0.07 (10-12-2008)
Plugin URI: http://itex.name/imoney
Description: Adsense, <a href="http://www.sape.ru/r.a5a429f57e.php">Sape.ru</a>, tnx.net/xap.ru and html inserts helper.
Author: Itex
...
class itex_money
{
	...
	function lang_ru()
	{
		...
		if ($locale == 'ru_RU')
		{
			...
			///ru_RU lang .mo file
			$input = '';
	...
	function itex_init_tnx()
	{
		...
		//if (!defined('_tnx_USER')) define('_tnx_USER', get_option('itex_m_tnx_tnxuser'));
		///else $this->error .= __('_tnx_USER already defined<br/>', 'iMoney');
...
//		include_once($file);
//		$this->tnx = new TNX_n(get_option('itex_m_tnx_tnxuser'), $dir); // ваш логин в системе
...
//		FOR MASS INSTALL ONLY, REPLACE if (0) ON if (1)
		//		if (0)
		//		{
		//			update_option('itex_tnx_tnxuser', 'abcdarfkwpkgfkhagklhskdgfhqakshgakhdgflhadh'); //tnx uid
		//			update_option('itex_tnxcontext_enable', 1);
		//			update_option('itex_tnx_enable', 1);
		//			update_option('itex_tnx_links_footer', 'max');
		//		}

		//echo $_SERVER['SCRIPT_URL'];
		//echo $_SERVER["SCRIPT_FILENAME"].__FILE__._tnx_USER.'/tnx.php';
		...
		//norkomans protection )), tak kak tnx progers ne produmali multihosting bag, mb ya mudag pravda))
		$dir .= '/..';
		for ($i = 0;$i<10;$i++) $dir .= '/..';
		$dir .= dirname($file).'/';
		...
		//print_r($this->tnx);
		//$f = $file.' '.$dir.' '.rand(0,999);die($f);
//		$o['charset'] = get_option('blog_charset')?get_option('blog_charset'):'UTF-8';
//		//$o['force_show_code'] = $this->force_show_code;
//		if (get_option('itex_m_tnx_check'))
//		{
//			$o['force_show_code'] = get_option('itex_m_tnx_check');
//		}
//		$o['multi_site'] = true;

		//$this->itex_tnx_safe_url();
		//$link = $this->itex_tnx_safe_url();print_r($link);die();
...
//		if (get_option('itex_m_tnxcontext_enable'))
//		{
//			$this->tnxcontext = new tnx_context($o);
//			//add_filter('the_content', array(&$this, 'itex_tnx_replace'));
//			//add_filter('the_excerpt', array(&$this, 'itex_tnx_replace'));
//		}



		//print_r($o);die();
		//print_r($this->tnx->show_link(2));die();
		return 1;
	}
...
//--></script><script type="text/javascript" src="http://pagead2.googlesyndication.com/pagead/show_ads.js"></script></p>';
	...
	function itex_init_html()
	{
		...
		if (get_option('itex_m_html_sidebar_enable')) $this->sidebar['iMoney_html'] = get_option('itex_m_html_sidebar');
		if (get_option('itex_m_html_footer_enable')) $this->footer .= get_option('itex_m_html_footer');
		if (get_option('itex_m_html_beforecontent_enable')) $this->beforecontent .= get_option('itex_m_html_beforecontent');
		if (get_option('itex_m_html_aftercontent_enable')) $this->aftercontent .= get_option('itex_m_html_aftercontent');
	}
...
//		echo '
//  			<p>
//    			<label for="itex_m_widget">'._e('Widget Title: ', 'iMoney').'</label>
...
//			
        		...
        		<h3>Html</h3>
       	 		...
       	 		<h3>Sape</h3>
        		<p><?php $this->itex_m_admin_sape(); ?></p>
       	 		<h3>Tnx/Xap</h3>
       	 		<p><?php $this->itex_m_admin_tnx(); ?></p><br/>
       	 		
			</div>
			<p class="submit">
				<input type='submit' name='info_update' value='<?php echo _e('Save Changes', 'iMoney'); ?>' />
			</p>
			<p align="center">
				<?php echo _e("Powered by <a href='http://itex.name' title='iTex iMoney'>iTex iMoney</a> Version:",'iMoney'); echo $this->version; ?>
			</p>				
			</form>
		...
		<table class="form-table" cellspacing="2" cellpadding="5" width="100%">
				...
				<tr>
					...
					<td>
						...
						echo '<label for="">'._e('Context', 'iMoney').'</label>';
				...
				<tr>
					<th width="30%" valign="top" style="padding-top: 10px;">
						<label for=""><?php echo _e('Check:', 'iMoney'); ?></label>
					</th>
					<td>
						<?php
		...
		<table class="form-table" cellspacing="2" cellpadding="5" width="100%">
				...
				<tr>
					...
					<td>
						...
						echo "id='html_footer'>";
						echo get_option('itex_m_html_footer')."</textarea>\n";
						?>
				...
				<tr>
					...
					<td>
						...
						echo get_option('itex_m_html_beforecontent')."</textarea>\n";
						?>
						<p style="margin: 5px 10px;"><?php echo __('Enter your html in this box.', 'iMoney');?></p>
				...
				<tr>
					...
					<td>
						...
						echo get_option('itex_m_html_aftercontent')."</textarea>\n";
						?>
						<p style="margin: 5px 10px;"><?php echo __('Enter your html in this box.', 'iMoney');?></p>
				...
				<tr>
					...
					<td>
						...
						echo get_option('itex_m_html_sidebar')."</textarea>\n";
						?>
						<p style="margin: 5px 10px;"><?php echo __('Enter your html in this box.', 'iMoney');?></p>
